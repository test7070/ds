	...
	<head>
		...
		<script type="text/javascript">
            ...
            function q_seekStr() {
                ...
                t_btireno = $.trim($('#txtEtireno').val());
                t_etireno = $.trim($('#txtEtireno').val());
                ...
                if (t_btireno.length>0)
                	t_where += " and exists(select noa from tires where tires.noa=tire.noa and patindex('%" + t_btireno + "%',tires.btireno)>0)";
                if (t_etireno.length>0)
                	t_where += " and exists(select noa from tires where tires.noa=tire.noa and patindex('%" + t_etireno + "%',tires.etireno)>0)";
	...
	<body>
		<div style='width:400px; text-align:center;padding:15px;' >
			<table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
				...
				<tr class='seek_tr'>
					<td class='seek'  style="width:20%;"><a id='lblCarplateno'> </a></td>
					<td>
				...
				<tr class='seek_tr'>
					<td class='seek'  style="width:20%;"><a id='lblBtireno'> </a></td>
					<td>
					<input class="txt" id="txtBtireno" type="text" style="width:215px; font-size:medium;" />
					</td>
				</tr>
				<tr class='seek_tr'>
					<td class='seek'  style="width:20%;"><a id='lblEtireno'> </a></td>
					<td>
					<input class="txt" id="txtEtireno" type="text" style="width:215px; font-size:medium;" />
					</td>
				</tr>
			</table>
