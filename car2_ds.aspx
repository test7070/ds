        ...
        <script type="text/javascript">
            ...
            function mainPost() {
				...
				$('#btnCarsalary').click(function(e) {
					q_box("carsalary.aspx?;;;noa='" + $('#txtNoa').val() + "'", 'carsalary', "95%", "95%", q_getMsg("popCarsalary"));
				});
				$('#btnCarinsurance').click(function(e) {
					q_box("carinsure_ds.aspx?;;;noa='" + $('#txtNoa').val() + "'", 'carinsure', "95%", "95%", q_getMsg("popCarinsure"));
				});
				...
				$('#btnCarchange').click(function(e) {
					q_box("carchange.aspx?;;;noa='" + $('#txtCarno').val() + "'", 'carchange', "95%", "95%", q_getMsg("popCarchange"));
				});
				$('#btnOil').click(function(e) {
					q_box("oil.aspx?;;;carno='" + $('#txtCarno').val() + "'", 'oil', "95%", "95%", q_getMsg("popOil"));
				});
				$('#btnCartax').click(function(e) {
					q_box("cartax.aspx?;;;a.carno='" + $('#txtCarno').val() + "' and (caritemno='501' or caritemno='502') order by a.mon desc", 'cartax', "95%", "95%", q_getMsg("popCartax"));
				});
				/*$('#lblCarstyle').click(function(e) {
					q_box("carstyle.aspx", 'carstyle', "90%", "600px", q_getMsg("popCarstyle"));
				});*/
				$('#lblCarkind').click(function(e) {
					q_box("carkind.aspx", 'carspec', "95%", "95%", q_getMsg("popCarkind"));
				});
				$('#lblCarspec').click(function(e) {
					q_box("carspec.aspx", 'carspec', "95%", "95%", q_getMsg("popCarspec"));
				});
		...
		<div id='dmain' >
			...
			<div class="dbbm">
				<table class="tbbm"  id="tbbm">
					...
					<tr>
						<td><span> </span><a id="lblCarkind" class="lbl btn"> </a></td>
