...
<head>
    ...
    <script language="c#" runat="server">
        public void Page_Load()
        {
            ...
            //Response.Write("<p/>");
            //Response.Write("<div >");
            //Response.Write("<form name='form1' method='post' action='upload.aspx' enctype='multipart/form-data' style='width:400px'>  ");
            //Response.Write("<input type='file' name='btnFile1' style='font-size:16px;'/>");
            //Response.Write("<input type='file' name='btnFile1' style='font-size:16px;'/>");
            //Response.Write("<input type='submit' name='btnUpload' value='上傳' style='font-size:16px;'/>");
            //Response.Write("   <p class='style1'>GPS 資料上傳</p>");
            //Response.Write("<p class='style1'>ETC 資料上傳</p>");
            //Response.Write("<p class='style1'>中鋼租車 資料上傳</p>");
            //Response.Write("<p class='style1'>中鋼外銷 資料上傳</p>");
            //Response.Write("<p class='style1'>中鋼內銷 資料上傳</p>");
            //Response.Write("</form>");
...
//origin
            ...
            try
            {
				...
				System.IO.FileStream fs = new System.IO.FileStream(savepath + filename.Substring(0, end) + "^$__" + t_userno + filename.Substring(end), System.IO.FileMode.OpenOrCreate);
...
<p>&nbsp;</p>
<div>
<form id="Form1" name='form1' method='post' action='uploadDS.aspx' runat="server" 
...
<input type='submit' name='btnUpload' value='上傳' style='font-size:16px;'/>
    <p class='style1'>GPS 資料上傳 檔名格式=GPS*.*</p>
<p class='style1'>ETAG 資料上傳 檔名格式=ETAG*.xls</p>
<p class='style1'>長輝GPS里程數 檔名格式 = MILEAGE.XLS</p>
<p class='style1'>台糖加油站    檔名格式 = TAISUGAR.XLS</p>
<p class='style1'>中鋼租車 資料上傳&nbsp; 檔名格式=CSA </p>
<p class='style1'>中鋼外銷 資料上傳&nbsp; 檔名格式=CSC_DS</p>
<p class='style1'>中鋼內銷 資料上傳&nbsp; 檔名格式=CSIA053.txt</p>
<p class='style1'>中鋼運輸單價異動 資料上傳&nbsp; 檔名格式=ADDR.XLS</p>
<p class='style1'>中油&nbsp;&nbsp;&nbsp;&nbsp; 資料上傳&nbsp; 檔名格式=CPC.CSV WEICHIH</p>
