...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
            ...
            function mainPost() {
                q_getFormat();
                bbmMask = [['txtBirthday', r_picd], ['txtIndate', r_picd], ['txtOutdate', r_picd]];
                q_mask(bbmMask);
            ...
            function _btnSeek() {
                if (q_cur > 0 && q_cur < 4)// 1-3
                    return;
                q_box('sss_ds_s.aspx', q_name + '_s', "550px", "400px", q_getMsg("popSeek"));
            }
            function btnIns() {
                _btnIns();
                refreshBbm();
            ...
            function btnPrint() {
            	q_box('z_sss_ds.aspx' + "?;;;;" + r_accy + ";noa=" + trim($('#txtNoa').val()), '', "95%", "95%", q_getMsg("popPrint"));
            }
			function q_stPost() {
                if (!(q_cur == 1 || q_cur == 2))
                    return false;
			...
			<div class="dbbm">
				<table class="tbbm"  id="tbbm">
					...
					<tr>
						...
						<td colspan="5">
							<input id="txtZip_conn" type="text" style="float:left; width:10%;"/>
							<input id="txtAddr_conn"  type="text" style="float:left; width:90%;"/>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td> </td>
						<td colspan="5">
							<input id='btnSaladjust' type="button" style="float:left; width:120px;"/>
							<input id='btnFamily' type="button" style="float:left; width:120px;"/>
						</td>
					</tr>
					<tr>
