    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function q_seekStr() {
                ...
                if (t_tgg.length>0)
                    t_where += " and exists(select noa from rc2s"+r_accy+" where rc2s"+r_accy+".noa=rc2"+r_accy+".noa and charindex('" + t_tgg + "',rc2s"+r_accy+".tgg)>0)";
                if (t_product.length>0)
                    t_where += " and exists(select noa from rc2s"+r_accy+" where rc2s"+r_accy+".noa=rc2"+r_accy+".noa and charindex('" + t_product + "',rc2s"+r_accy+".product)>0)";
