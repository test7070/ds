	...
	<head>
		...
		<script type="text/javascript">
			...
			carcsbData.prototype={
				...
				init : function(){
            		Lock(1,{opacity:0});
            		q_gt('calctypes', '', 0, 0, 0, 'carcsbInit_1');
            	},
			...
			<div class="dview" id="dview">
				<table class="tview" id="tview">
					<tr>
						...
						<td align="center" style="width: 80px; color:black;"><a id='vewInmoney'> </a></td>
						<td align="center" style="width: 80px; color:black;"><a id='vewDiscount'> </a></td>
					</tr>
					<tr>
