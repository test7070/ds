...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
    <head>
        ...
        <script type="text/javascript">
            ...
            function bbsAssign() {
                for (var i = 0; i < q_bbsCount; i++) {
                    ...
                    if ($('#btnMinus_' + i).hasClass('isAssign'))/// 重要
                        continue;
                    $('#txtR1_'+i).change(function(e){sum();});    
                    $('#txtR2_'+i).change(function(e){sum();});    
                }
                _bbsAssign();
            }
            ...
            function sum() {
                for(var i=0;i<q_bbsCount;i++){
                    $('#txtDiscount_'+i).val(round((1-q_float('txtR1_'+i)/100)*q_float('txtR2_'+i)/100,3));
                }
            }
        ...
        <div class='dbbs'>
            <table id="tbbs" class='tbbs'>
                <tr style='color:white; background:#003366;' >
                    ...
                    <td align="center" style="width:50px;"><a id='lblTypea_s'> </a></td>
                    <td align="center" style="width:50px;"><a id='lblIsoutside_s'> </a></td>
                    <td align="center" style="width:100px;">扣％(百分比)</td>
                    <td align="center" style="width:100px;">抽成(百分比)</td>
                ...
                <tr  style='background:#cad3ff;'>
                    ...
                    <td><input type="text" id="txtR1.*" style="width:95%;text-align: right;" /></td>
                    <td><input type="text" id="txtR2.*" style="width:95%;text-align: right;" /></td>
